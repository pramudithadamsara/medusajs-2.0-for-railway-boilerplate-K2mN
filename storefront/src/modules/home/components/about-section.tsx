        ...
        <div className="py-24 bg-brand-neutral/30">
            <div className="content-container flex flex-col gap-24">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-24 items-center">
                    ...
                    <div className="flex flex-col gap-8 md:order-2 order-1">
                        <Heading level="h2" className="text-3xl text-brand-brown font-serif">Premium Ceylon Spices</Heading>
                        <Text className="text-ui-fg-subtle text-lg font-light leading-loose">
                            Each spice in our collection represents the pinnacle of Ceylon's agricultural heritage. From the golden threads of true Ceylon cinnamon to the pungent cloves and aromatic cardamom, we source only the finest harvests from select plantations across the island.
                        </Text>
                        <Text className="text-ui-fg-subtle text-lg font-light leading-loose">
                            Our spices are hand-picked at peak freshness, carefully processed to preserve their essential oils and distinctive flavors, and delivered to you with the same care and attention that has made Ceylon spices legendary for centuries.
                        </Text>
                    </div>
                </div>
